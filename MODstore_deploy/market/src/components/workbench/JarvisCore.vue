...
.work-mode.jarvis-core.speaking .jarvis-sphere {
  animation: breatheWork 1s ease-in-out infinite;
}

.monitor-mode.jarvis-core.speaking .jarvis-sphere {
  animation: breatheMonitor 1s ease-in-out infinite;
}
...
@keyframes breatheMonitor {
  ...
  50% {
    transform: scale(1.1);
    box-shadow: 0 0 44px rgba(255, 215, 0, 0.75);
  }
}
</style>
